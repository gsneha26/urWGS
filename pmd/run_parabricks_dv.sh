...
time sudo pbrun deepvariant \
        --ref /data/GRCh37.fa \
        --in-bam /data/$1_folder/margin/MARGIN_PHASED.PEPPER_SNP_MARGIN.HEADER_FIXED.SAMTOOLS.haplotagged.bam \
        --out-variants /data/$1_folder/${SAMPLE}_pmd_$1.vcf \
        --pb-model-file /data/pb_model/deepvar_ont_kishwar_P100.eng \
        --proposed-variants /data/$1_folder/pepper_hp/PEPPER_VARIANT_HP_OUTPUT.vcf.gz \
        --sort-by-haplotypes \
